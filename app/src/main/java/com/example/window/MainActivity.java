...
public class MainActivity extends ListActivity {
    ...
    String[] things = {"Аргентина", "Бразилия", "Чили", "Колумбия", "Уругвай", "Я"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    case 0:
                        ...
                        break;
                    case 1:
                        Intent intent2 = new Intent(MainActivity.this, Brazily.class);
                        startActivity(intent2);
                        break;
                    case 2:
                        Intent intent3 = new Intent(MainActivity.this, Hili.class);
                        startActivity(intent3);
                        break;
                    case 3:
                        Intent intent4 = new Intent(MainActivity.this, Kolumbiya.class);
                        startActivity(intent4);
                        break;
                    case 4:
                        Intent intent5 = new Intent(MainActivity.this, Urygvay.class);
